<div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group" style=" display: flex; flex-direction: column;">
                                ...
                                <select id="areaseleccionada" wire:model="areaseleccionada"
                                    class="mb-3 shadow-none form-select form-select-smmt-5">
                            ...
                            <div style=" display: flex; flex-direction: column;">
                                ...
                                <input type="date" id="fecha-inicio" wire:model="fechaInicioMes"
                                    onkeydown="return false" class="form-control form-control-sm">
                            </div>
                            ...
                            <div class="form-group" style=" display: flex; flex-direction: column;">
                                ...
                                <select id="usuarioseleccionado" wire:model="usuarioseleccionado"
                                    class="mb-3 shadow-none form-select form-select-smmt-5">
                            ...
                            <div class="d-flex">
                                <button id="export-btn" class="mr-1 btn btn-success">Exportar a Excel</button>
    ...
    <script>
        ...
        function exportPdf() {
            ...
            const fechaInicioMes = document.getElementById('fecha-inicio').value;
            const fechaActual = document.getElementById('fecha-actual').value;
            const usuarioseleccionado = document.getElementById('usuarioseleccionado').value;
    ...
    <script>
        document.getElementById('export-btn').addEventListener('click', function(event) {
            event.preventDefault();
            exportTableToExcel('data-table', 'gastos');
        });
