   ...
   <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="border-0 shadow-sm card">
                <div class="card-body">
                    <h3 class="card-title">REGISTRO DE PRODUCTOS MODIFICADOS</h3>
                    <div class="mb-2">
                        <div class="input-group" style=" border-radius: 5px;">
                            <input type="text" class="form-control" wire:model="busqueda" placeholder="Buscar Producto...">
                        </div>
                    </div>
                    <div class="mb-2">
                        <span>Se están mostrando: {{ $registrotraspaso }} productos modificados.</span>
                    </div>
