<div>
    <a class="mr-2 btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"
        data-original-title="Editar" wire:click="$set('editar',true)">
    ...
    @if ($tratamiento->estado == 'Activo')
        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar"
            data-original-title="Eliminar" wire:click="inactivarTratamiento">
            <i class="fas fa-trash"></i>
        </a>
    @else
        <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"
            data-original-title="Edit" wire:click="activarTratamiento">
        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-4 text-sm text-gray-600">
                <form>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="">Minutos estimados en realizar:</label>
                        <input type="number" class="form-control" id="exampleInputDisabled1"
                            wire:model.defer="tratamiento.hora">
                    </div>
                </form>
            </div>
        </div>
