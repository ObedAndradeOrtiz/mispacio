<div>
    ...
    <div class="flex flex-row justify-between">
        <h3 style="font-size: 18px;"> <strong>LISTA DE ABREVIATURAS</strong> </h3>
        @livewire('marketing.crear-abreviatura')
    </div>
            ...
            <tbody>
                @foreach ($abreviaturas as $item)
                    <tr>
                        ...
                        <td>{{ $item->sucursal }}</td>
                        <td> <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Edit" data-original-title="Edit" wire:click="">
