<div style="margin-bottom: 5%" class="mt-4">
    <style>
    ...
    <div class="mt-2 border-0 shadow-sm card h-100">
        <div class="text-center card-header">
            ...
            <div class="gap-3 card-options d-flex justify-content-center">
                            ...
                            @foreach ($llamadas as $lista)
                                ...
                                <tr>
                                    @if ($haypago)
                                        ...
                                        <!-- Ícono de check con color verde -->
                                    @else
                                        <td><i class="fas fa-times-circle text-danger"></i></td>
                                        <!-- Ícono de X con color rojo -->
                                    @endif
                                    ...
                                    <td>{{ $lista->hora . ' - ' . $fecha_formateada }}</td>
                                    <td>{{ $lista->area }}</td>
                                    <td>
                                        {{ $lista->responsable }}
                                    </td>
    ...
    <x-sm-modal wire:model.defer="recordar">
        <div class="px-6 py-4">
